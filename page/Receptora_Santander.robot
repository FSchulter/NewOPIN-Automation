...
*** Variables ***
${RECEPTORA_SANTANDER_AUTO_PROD}                 https://openinsurance.santanderauto.com.br/data-pull/bem-vindo
${URL_PRECADASTRO_SANTANDER_AUTO_PROD}           https://openinsurance.santanderauto.com.br/data-pull/home
#MENU IDENTIFICACAO DO CLIENTE
${RADIO_BUTTON_PESSOA_FISICA}                    (//input[@type='radio'])[1]
${CPF_SANTANDER}                                 29807300843
${NOME_COMPLETO_CHUBB}                           Regressivo DCR, Santander e Chubb
${NOME_COMPLETO_CA2C}                            Regressivo DCR, Santander e CA2C    
${NOME_COMPLETO_HDI_DO_BRASIL}                   Regressivo DCR, Santander e HDI do Brasil
${NOME_COMPLETO_SICOOB_SEGUROS}                  Regressivo DCR, Santander e Sicoob Seguros
${NOME_COMPLETO_XP_PROVIDENCIA}                  Regressivo DCR, Santander e XP Providencia
${NOME_COMPLETO_ZURICH_SEGUROS}                  Regressivo DCR, Santander e Zurich Seguros
${NOME_COMPLETO_ZURICH_PREVIDENCIA}              Regressivo DCR, Santander e Zurich Previdencia
${NOME_COMPLETO_SANTANDER_CAPITALIZACAO}         Regressivo DCR, Santander e Santander Capitalizacao
${NOME_COMPLETO_BRADESCO_SEGUROS}                Regressivo DCR, Santander e Bradesco Seguros
${NOME_COMPLETO_ALLIANZ}                         Regressivo DCR, Santander e Allianz
${NOME_COMPLETO_CARDIF_PREVIDENCIA}              Regressivo DCR, Santander e Cardif Previdencia
${NOME_COMPLETO_CARDIF_SEGUROS}                  Regressivo DCR, Santander e Cardif Seguros
${NOME_COMPLETO_ICATU}                           Regressivo DCR, Santander e Icatu
${NOME_COMPLETO_SOMPO}                           Regressivo DCR, Santander e Sompo
${NOME_COMPLETO_CNP_CAPITALIZACAO}               Regressivo DCR, Santander e CNP Capitalizacao
${NOME_COMPLETO_BTG_PREVIDENCIA}                 Regressivo DCR, Santander e BTG Previdencia
${NOME_COMPLETO_BTG_SEGUROS}                     Regressivo DCR, Santander e BTG Seguros
${NOME_COMPLETO_RIO_GRANDE_SEGUROS}              Regressivo DCR, Santander e Rio Grande Seguros
${NOME_COMPLETO_ZURICH_BRASIL_SEGUROS}           Regressivo DCR, Santander e Zurich Brasil Seguros
${NOME_COMPLETO_INDIANA_SEGUROS}                 Regressivo DCR, Santander e Indiana Seguros
${NOME_COMPLETO_BRASILCAP}                       Regressivo DCR, Santander e Brasilcap
${NOME_COMPLETO_LUIZA_SEG}                       Regressivo DCR, Santander e Luiza Seg
${NOME_COMPLETO_PRUDENTIAL_BRASIL}               Regressivo DCR, Santander e PRUDENTIAL 
${NOME_COMPLETO_PORTO_SEGURO}                    Regressivo DCR, Santander e Porto Seguro
${NOME_COMPLETO_AUSTRAL}                         Regressivo DCR, Santander e Austral
${NOME_COMPLETO_DARWIN_SEGUROS}                  Regressivo DCR, Santander e Darwin Seguros
${NOME_COMPLETO_CAIXA_SEGURADORA}                Regressivo DCR, Santander e Caixa Seguradora
${NOME_COMPLETO_CAIXA_CAPITALIZACAO}             Regressivo DCR, Santander e Caixa Capitalizacao
${NOME_COMPLETO_CAIXA_RESIDENCIAL}               Regressivo DCR, Santander e Caixa Residencial
${NOME_COMPLETO_CAIXA_PREVIDENCIA_VIDA}          Regressivo DCR, Santander e Caixa Previdencia Vida
${NOME_COMPLETO_SWISS_RE}                        Regressivo DCR, Santander e Swiss Re
${NOME_COMPLETO_SIMPLE2U}                        Regressivo DCR, Santander e Simple2u
${NOME_COMPLETO_EVIDENCE}                        Regressivo DCR, Santander e Evidence
${NOME_COMPLETO_SUL_AMERICA}                     Regressivo DCR, Santander e Sul America
${NOME_COMPLETO_NEO_SEGURADORA}                  Regressivo DCR, Santander e Neo Seguradora
${NOME_COMPLETO_PREVISUL}                        Regressivo DCR, Santander e Previsul
${NOME_COMPLETO_ITAU_SEGUROS}                    Regressivo DCR, Santander e Itau Seguros
${NOME_COMPLETO_BRASILSEG}                       Regressivo DCR, Santander e Brasilseg
${NOME_COMPLETO_TOKIO_MARINE}                    Regressivo DCR, Santander e Tokio Marine
${NOME_COMPLETO_YELUM_SEGUROS}                   Regressivo DCR, Santander e Yelum Seguros
${NOME_COMPLETO_TOO_SEGUROS}                     Regressivo DCR, Santander e Too Seguros
${NOME_COMPLETO_JUSTOS_SEGUROS}                  Regressivo DCR, Santander e Justos Seguros
${NOME_COMPLETO_MAPFRE}                          Regressivo DCR, Santander e Mapfre
${NOME_COMPLETO_BRASILPREV}                      Regressivo DCR, Santander e Brasilprev
${NOME_COMPLETO_SAFRA_SEGUROS}                   Regressivo DCR, Santander e Safra Seguros
${NOME_COMPLETO_HDI_GLOBAL}                      Regressivo DCR, Santander e HDI Global
${NOME_COMPLETO_HDI_SEGUROS}                     Regressivo DCR, Santander e HDI Seguros
