...
*** Variables ***
#AREA DE LOGIN
${TELA_LOGIN_TRANSMISSORA_SANTANDER}                  //button[contains(@ng-reflect-ng-class,'[object Object]')]
...
#AREA LOGADA     
${CHECKBOX_APOLICE_TRANSMISSORA_HDI_AUTO}             //input[contains(@id,'04001904327776')]
${CHECKBOX_APOLICE_TRANSMISSORA_STA_AUTO}             //input[contains(@id,'04001904586611')]  
...
#EMAIL SÓCIOS
${ESCREVER_EMAIL_REQUERENTE}                          teste_STA02@opinteste.com.br
${BUTTON_SALVAR1}                                     //*[@id="btnEmail-rec"]                 
${ESCREVER_EMAIL_SOCIO}                               teste_STA01@opinteste.com.br
...
Sou direcionado AREA LOGADA TRANSMISORA OPIN e seleciono produto "${apolice_santander_auto}"
    Wait Until Element Is Not Visible        ${AGUARDAR_CARREGAMENTO}     timeout=10 
    Click Element                            ${apolice_santander_auto}    action_chain=true
...
preencho com a informacao de e-mail do primeiro socio "${email_requerente}" e clico em salvar "${button_salvar1}"
    Sleep                     1   
    Input Text                (//input[@placeholder='Digite o email'])[1]   ${email_requerente}
...
Apos carregar informacoes sou direcionado para tela de CALL BACK
    ...
    Wait Until Page Does Not Contain Element    ${AGUARDAR_CARREGAMENTO}    timeout=40
    Wait Until Page Does Not Contain Element    ${AGUARDAR_REDIRECIONAMENTO}    timeout=40
    Wait Until Element Is Visible               //*[@title="Resumo do Compartilhamento"]    timeout=20
