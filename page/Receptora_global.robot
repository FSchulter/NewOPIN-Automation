...
*** Variables ***
#TELA PORTAL OPIN
${URL_RECEPTORA_HDI_GLOBAL_HML}                  https://openinsurance-int.hdiglobalbrasil.com.br/data-pull/bem-vindo
${URL_PRECADASTRO_GLOBAL_HML}                    https://openinsurance-int.hdiglobalbrasil.com.br/data-pull/home

#MENU IDENTIFICACAO DO CLIENTE
${RADIO_BUTTON_PESSOA_FISICA}                    (//input[@type='radio'])[1]
${RADIO_BUTTON_PESSOA_JURIDICA}                  (//input[@type='radio'])[2]
...
na pagina de pre cadastro, seleciono o ${radio_button_pessoa_fisica_ou_juridica}
    Click Element                             ${radio_button_pessoa_fisica_ou_juridica}   
