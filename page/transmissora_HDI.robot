...
*** Variables ***
#AREA DE LOGIN
${TELA_LOGIN_TRANSMISSORA_HDI}                        //button[contains(@ng-reflect-ng-class,'[object Object]')]
...
#AREA LOGADA                       
${CHECKBOX_APOLICE_TRANSMISSORA_HABITACIONAL}         //input[@id='01104261000015CERT10265695']
${CHECKBOX_PRODUTO_TRANSMISSORA_PATRIMONIAL}          //input[@id='01118005000076']
...
#EMAIL SÓCIOS
${ESCREVER_EMAIL_REQUERENTE}                          opin_1@opinteste.com.br
${BUTTON_SALVAR1}                                     //*[@id="btnEmail-rec"]                 
${ESCREVER_EMAIL_SOCIO}                               opin_2@opinteste.com.br
...
seleciono o button ${button_cnpj_ou_cpf}
    Click Button   ${button_cnpj_ou_cpf}

clico em ${place_holder_cnpj} preencho o input filed CNPJ ${massa_hdi.cnpj} 
    Input Text    ${place_holder_cnpj}    ${massa_hdi.cnpj}    

clico em ${place_holder_cpf} preencho o input field USUARIO ${massa_hdi.cpf} 
    Input Text    ${place_holder_cpf}    ${massa_hdi.cpf}    

clico em ${place_holder_senha} preencho o input field SENHA ${massa_hdi.senha} 
    Input Text    ${place_holder_senha}    ${massa_hdi.senha}
...
preencho com a informacao de e-mail do primeiro socio "${email_requerente}" e clico em salvar "${button_salvar1}"
    Sleep                     1   
    Input Text                //input[@id='inputEmail-requerent']    ${email_requerente}
...
preencho com a informacao de e-mail do segundo socio "${email_socio}" e clico em salvar "${button_salvar2}"
    Input Text                //input[@id='inputEmail-0']   ${email_socio}
