...
Caso de teste 01 - Preencher dados pre-cadastro receptora PJ GLOBAL, Transmitir para HDI
    ...
    #Dado que
    Acesso o Portal OPIN em HML da receptora ${URL_RECEPTORA_HDI_GLOBAL_HML}
    #e
    clico em comecar
    sou direcionado para página de preenchimento de dados de pre-cadastro ${URL_PRECADASTRO_GLOBAL_HML}
...
Caso de teste 03 - Selecionar produto e realizar transmissão
    ...
    ...                da Transmissora PJ HDI Seguros para Receptora PJ Global
