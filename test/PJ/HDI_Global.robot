*** Settings ***
Documentation    Esta suite testa o fluxo PJ HDI receptora e Global transmissora
...
Caso de teste 01 - Preencher dados pre-cadastro receptora PJ GLOBAL, Transmitir para HDI
    [Documentation]    Este teste preenche dados pre-cadastro receptora PJ HDI
    [Tags]             PRE-cadastro   HDI_receptora_PJ   Global_transmissora_PJ
    #Dado que
    ...
    no sub-menu IDENTIFICAO DO CLIENTE clico e preencho com ${MASSA_GLOBAL_PJ.cnpj} , ${MASSA_GLOBAL_PJ.cpf}, ${MASSA_GLOBAL_PJ.nome}, ${EMAIL} e clico na checkbox ${CHECKBOX_IDENTIFICAO_CLIENTE_PJ} 
 ...
 Caso de teste 02 - Prencher dados portal TRANSMISSORA com CNPJ, CPF, SENHA e realizar LOGIN
    ...
    [Tags]             LOGIN    HDI_receptora_PJ    Global_transmissora_PJ
    #Dado que
    Sou direcionado TRANSMISSORA OPIN ${TELA_LOGIN_TRANSMISSORA_GLOBAL} e clico em comecar
    #e
    seleciono o button ${BUTTON_CNPJ}
    clico em ${PLACE_HOLDER_CNPJ_TRANSMISSORA} preencho o input filed CNPJ ${MASSA_GLOBAL_PJ.cnpj}
    clico em ${PLACE_HOLDER_CPF_TRANSMISSORA} preencho o input field USUARIO ${MASSA_GLOBAL_PJ.cpf}
    #quando
...
Caso de teste 03 - Selecionar produto e realizar transmissão
    ...
    ...                da Transmissora PJ Global para Receptora PJ HDI Seguros
    [Tags]             Selecao_produtos    Call_back    Global_receptora_PJ    HDI_transmissora_PJ
    #Dado que 
